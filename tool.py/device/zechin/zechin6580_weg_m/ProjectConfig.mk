...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT MTK_ATV_CHIP CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO HW_BOARD_NAME PRJ_NAME SUB_PRJ_NAME FLASH_64_8 FLASH_DDR PROJECT_NAME PROJECT_SHORTNAME PROJECT_SCREEN PROJECT_NETWORK PROJECT_CUSTOMER PROJECT_BATTERY PROJECT_RF_BAND BATTERY_TYPE
#cz add hw and project name
HW_BOARD_NAME = __HW_BOARD_L388_V10__
# PRJ_NAME = __PROJECT_S89__
# SUB_PRJ_NAME = __PROJECT_S89P_HD__
PRJ_NAME = __PROJECT_F8__
SUB_PRJ_NAME = __PROJECT_L388_HD720__
FLASH_64_8=__FLASH_64_8_DDR2__
# __FLASH_64_512__
#add end.
...
CUSTOM_BUILD_VERNO =
#cz mod CUSTOM_CONFIG_MAX_DRAM_SIZE = 0x20000000
...
# cz mod CUSTOM_HAL_IMGSENSOR = gc0310_yuv imx179_mipi_raw ov5670_mipi_raw
CUSTOM_HAL_IMGSENSOR = imx237_mipi_raw imx149_mipi_raw imx190_mipi_raw gc2385_mipi_raw
# cz mod mtk before CUSTOM_HAL_LENS = ad5820af dw9714af dummy_lens
CUSTOM_HAL_LENS = dw9714af dw9761_bu64241af fm50af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
# cz mod CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af dw9761_bu64241af fm50af
# cz mod CUSTOM_HAL_MAIN_IMGSENSOR = imx179_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = imx237_mipi_raw imx149_mipi_raw
# cz mod CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MAIN_LENS = dw9714af dw9761_bu64241af fm50af
...
# cz mod CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_BACKUP_LENS =
# cz mod CUSTOM_HAL_SUB_IMGSENSOR = gc0310_yuv
CUSTOM_HAL_SUB_IMGSENSOR = imx190_mipi_raw gc2385_mipi_raw
...
# cz del gyro
# mtk before CUSTOM_KERNEL_GYROSCOPE = yes
CUSTOM_KERNEL_GYROSCOPE = no
# mod end.
CUSTOM_KERNEL_HDMI =
CUSTOM_KERNEL_HEADSET = accdet
# cz mod CUSTOM_KERNEL_IMGSENSOR = gc0310_yuv imx179_mipi_raw ov5670_mipi_raw
CUSTOM_KERNEL_IMGSENSOR = imx237_mipi_raw imx149_mipi_raw imx190_mipi_raw gc2385_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
# cz mod CUSTOM_KERNEL_LENS = ad5820af dw9714af dummy_lens
CUSTOM_KERNEL_LENS = dw9714af dw9761_bu64241af fm50af dummy_lens
# cz mod
# mtk before CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAGNETOMETER = no
# mod end.
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
# cz mod CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af dw9761_bu64241af fm50af
# cz mod CUSTOM_KERNEL_MAIN_IMGSENSOR = imx179_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx237_mipi_raw imx149_mipi_raw
# cz mod CUSTOM_KERNEL_MAIN_LENS = dw9714af
CUSTOM_KERNEL_MAIN_LENS = dw9714af dw9761_bu64241af fm50af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW =
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
# cz mod CUSTOM_KERNEL_SUB_BACKUP_LENS = ad5820af
CUSTOM_KERNEL_SUB_BACKUP_LENS =
# cz mod CUSTOM_KERNEL_SUB_IMGSENSOR = gc0310_yuv
CUSTOM_KERNEL_SUB_IMGSENSOR = imx190_mipi_raw gc2385_mipi_raw
CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = GT1XX
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
# cz mod mtk before CUSTOM_MODEM = zechin6580_we_m_hspa zechin6580_we_m_gprs
CUSTOM_MODEM=f8_hspa_band15 f8_gprs_band15
# mod end.
...
# cz mod for L388 dual sim card GEMINI = no
GEMINI = yes
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.34_zechin6580.weg.m_P142
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
...
# cz mod for L388 dual sim card MTK_GEMINI_ENHANCEMENT = no
...
# cz mod mtk befoe MTK_HOTKNOT_SUPPORT = yes
...
#ccz MTK_NFC_GSMA_SUPPORT = yes
MTK_NFC_GSMA_SUPPORT = no
MTK_NFC_HCE_SUPPORT = no
MTK_NFC_MT6605 = no
#ccz MTK_NFC_OMAAC_SUPPORT = yes
...
# cz mod for L388 dual sim card MTK_SHARE_MODEM_CURRENT = 1
...
# cz mod MTK_SIM_HOT_SWAP_COMMON_SLOT = no
...
OP01_COMPATIBLE = no
# cz mod OPTR_SPEC_SEG_DEF = OP105_SPEC0100_SEGDEFAULT
...
#CREATE_PROJECT_INFO=20160217114852
MTK_BUILD_ROOT = yes
XHL_WITH_DEXPREOPT = yes
BATTERY_TYPE = __PROJECT_BATTERY_L388_366485_3100_435V__
BUILD_GMS = yes
